...
class KeyboardViewController: UIInputViewController {
    ...
    @objc func keyTapped(_ sender: UIButton) {
        ...
        // Check the current text after the button tap
           if let currentText = textDocumentProxy.documentContextBeforeInput, currentText.hasSuffix("TEST") {
               // Update the suggestion label
               suggestionLabel.text = "Sensitive text detected!"
           } else {
               // Reset the suggestion label or leave it empty
